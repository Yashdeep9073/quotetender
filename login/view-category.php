                                    ...
                                    <tbody>
                                        ...
                                        while ($row = mysqli_fetch_row($result)) {
                                            ...
                                            <tr class='record'>
                                                ...
                                                <td>
                                                    <img src="category/<?php echo $row['5']; ?>"
                                                        style="width:150px;height:150px" />
                                                </td>
                                                <td>
                                                    <?php if ($isAdmin || hasPermission('Edit Category', $privileges, $roleData['role_name'])) { ?>
                                                        <a href='category-edit.php?id=<?php echo $res; ?>'>
                                                            <button type='button' class='btn btn-warning'>
                                                                <i class='feather icon-edit'></i> &nbsp;Edit
                                                            </button>
                                                        </a> &nbsp;
                                                    <?php } ?>
                                                    <?php if ($isAdmin || hasPermission('Delete Category', $privileges, $roleData['role_name'])) { ?>
