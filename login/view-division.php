                                    ...
                                    <tbody>
                                        ...
                                        while ($row = mysqli_fetch_row($result)) {
                                            ...
                                            <tr class='record'>
                                                ...
                                                <td>
                                                    <?php if ($isAdmin || hasPermission('Edit Division', $privileges, $roleData['role_name'])) { ?>
                                                        <a href='division-edit.php?sect=<?php echo $res; ?>'>
                                                    ...
                                                    <?php if ($isAdmin || hasPermission('Delete Division', $privileges, $roleData['role_name'])) { ?>
