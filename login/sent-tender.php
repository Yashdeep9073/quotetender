...
<?php foreach($tenders2 as $tenderID => $tenderRequests){ ?>
            <div class="row">
                <div class="col-sm-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="dt-responsive table-responsive">
                                ...
                                echo "<tr class='table-success thead-light'>";
                                    echo "<th colspan='20' class='text-center'><h4 class='text-light'>Tender ID : <span class='text-light'>". $tenderID ."</span></h4></th>";
                                echo "</tr>";
                                echo "<tr>";
                                echo "<th>SNO</th>";
                                echo "<th>User</th>";
