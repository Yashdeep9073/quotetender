...
try {
    ...
    $stmtFetchReferenceCodeLogs = $db->prepare("
        SELECT 
            id,
            tender_id,
            old_reference_code,
            ...
            action_by,
            created_at
        FROM reference_code_logs
        ORDER BY id DESC
    ");
    $stmtFetchReferenceCodeLogs->execute();

    $logs = $stmtFetchReferenceCodeLogs
        ->get_result()
...
<head>
    <title>Reference Code Logs</title>
                    ...
                    <div class="row align-items-center">
                        <div class="col-md-12">
                            <div class="page-header-title">
                                <h5 class="m-b-10">Reference Code Logs
                                </h5>
                            </div>
                            <ul class="breadcrumb">
                                        ...
                                        if (!empty($logs)) {
                                            ...
                                            foreach ($logs as $log) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <strong>
                                                            <?php echo htmlspecialchars($log['tender_id']); ?>
                                                        </strong>
                                                    </td>

                                                    <td>
                                                        <?php echo $log['old_reference_code']
                                                            ? htmlspecialchars($log['old_reference_code'])
                                                            : '<span class="text-muted">—</span>'; ?>
                                                    </td>

                                                    <td>
                                                        <?php echo $log['new_reference_code']
                                                            ? htmlspecialchars($log['new_reference_code'])
                                                            : '<span class="text-muted">—</span>'; ?>
                                                    </td>
                                                    ...
                                                    <td>
                                                        <?php echo htmlspecialchars($log['action_reason']); ?>
                                                    </td>

                                                    <td>
                                                        <?php echo htmlspecialchars($log['action_by'] ?? 'System'); ?>
                                                    </td>
                                            ...
                                            ?>
                                            <tr>
                                                <td colspan="8" class="text-center">No reference code logs found</td>
                                            </tr>
                                            <?php
                                        }
                                        ?>
