                                    ...
                                    <tbody>
                                        ...
                                        while ($row = mysqli_fetch_row($result)) {
                                            ...
                                            <tr class='record'>
                                                ...
                                                <td>
                                                    <?php if ($isAdmin || hasPermission('Edit Sub Division', $privileges, $roleData['role_name'])) { ?>
                                                        <a href='sub-section-edit.php?sect=<?php echo $res; ?>'>
                                                            <button type='button' class='btn btn-warning'>
                                                                <i class='feather icon-edit'></i> &nbsp;Edit
                                                            </button>
                                                        </a> &nbsp;
                                                    <?php } ?>
                                                    <?php if ($isAdmin || hasPermission('Delete Sub Division', $privileges, $roleData['role_name'])) { ?>
